...
documentation {
    Represents the Redis client endpoint.
}
...
function close (CallerActions callerActions) {
    _ = check callerActions.close();
}

function createClient(ClientEndpointConfiguration clientEndpointConfig) returns CallerActions {
    CallerActions callerActions = new;
